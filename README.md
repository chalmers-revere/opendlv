...
* Command to run with Docker: `docker run --init --rm --net=host chalmersrevere/opendlv-device-gps-pos-multi:v0.0.8 --pos_ip=192.168.1.77 --pos_port=5602 --cid=111 --verbose`
...
services:    # Must be present exactly once at the beginning of the docker-compose.yml file
    dev-gps-pos:
        ...
        image: chalmersrevere/opendlv-device-gps-pos-multi:v0.0.8
        restart: on-failure
        network_mode: "host"
