...
* Command to run with Docker: `docker run --init --rm --net=host chalmersrevere/opendlv-device-gps-pos-multi:v0.0.9 --pos_ip=192.168.1.77 --pos_port=5602 --cid=111 --verbose`
...
services:    # Must be present exactly once at the beginning of the docker-compose.yml file
    dev-gps-pos:
        ...
        image: chalmersrevere/opendlv-device-gps-pos-multi:v0.0.9
        restart: on-failure
        network_mode: "host"
...
* Command to run with Docker: `docker run --init --rm --net=host chalmersrevere/opendlv-device-lidar-hdl32e-multi:v0.0.11 --hdl32e_ip=0.0.0.0 --hdl32e_port=2368 --cid=111 --nogpstime --verbose`
* Section for `docker-compose.yml`:
```yml
version: '2' # Must be present exactly once at the beginning of the docker-compose.yml file
services:    # Must be present exactly once at the beginning of the docker-compose.yml file
    dev-lidar-hdl32e:
        ...
        image: chalmersrevere/opendlv-device-lidar-hdl32e-multi:v0.0.11
        restart: on-failure
        network_mode: "host"
