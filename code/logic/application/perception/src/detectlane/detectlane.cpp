...
void DetectLane::setUp()
{
  ...
  m_adapThreshKernelSize = 
      kv.getValue<uint16_t>("perception-detectlane.adapThreshKernelSize");
  m_adapThreshConst = 
      kv.getValue<uint16_t>("perception-detectlane.adapThreshConst");
  m_cannyThreshold = 
      kv.getValue<uint16_t>("perception-detectlane.cannyThreshold");
  m_houghThreshold = 
      kv.getValue<uint16_t>("perception-detectlane.houghThreshold");
  ...
  m_HorisontalLimit = 
      kv.getValue<float>("perception-detectlane.HorisontalLimit");
  m_blurKernelSize = kv.getValue<uint16_t>("perception-detectlane.blurKernelSize");
  m_memThreshold = kv.getValue<double>("perception-detectlane.memThreshold");
  m_upperLaneLimit = 
      kv.getValue<uint16_t>("perception-detectlane.upperLaneLimit");
  m_lowerLaneLimit = 
      kv.getValue<uint16_t>("perception-detectlane.lowerLaneLimit");
