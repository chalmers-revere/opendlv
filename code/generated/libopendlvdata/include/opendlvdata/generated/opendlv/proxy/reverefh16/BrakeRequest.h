...
#ifndef OPENDLV_PROXY_REVEREFH16_BRAKEREQUEST_H
#define OPENDLV_PROXY_REVEREFH16_BRAKEREQUEST_H
		...
		namespace reverefh16 {
			...
			class BrakeRequest : public odcore::data::SerializableData, public odcore::base::Visitable {
				...
				public:
					...
					/**
					 * This method sets brake.
					 *
					 * @param val Value for brake.
					 */
					void setBrake(const double &val);
...
#endif /*OPENDLV_PROXY_REVEREFH16_BRAKEREQUEST_H*/
