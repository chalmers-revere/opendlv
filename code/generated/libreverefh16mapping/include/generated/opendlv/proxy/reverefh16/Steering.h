 ...
 */
// Header file for: opendlv.proxy.reverefh16.Steering
#ifndef OPENDLV_PROXY_REVEREFH16_STEERING_H_
#define OPENDLV_PROXY_REVEREFH16_STEERING_H_
			...
			namespace reverefh16 {
				...
				class Steering : public odcore::data::SerializableData, public odcore::base::Visitable {
				    ...
				    public:
				    	...
				    	void setSteeringRoadwheelangle(const double&);
				    	
				    	double getSteeringSteeringwheelangle() const;
				    	void setSteeringSteeringwheelangle(const double&);
				    ...
				    private:
				    	...
				    	double m_steeringSteeringwheelangle;
				    	
				    	std::map<uint64_t,uint64_t> m_payloads;
				    	std::vector<uint64_t> m_neededCanMessages;
				    	uint64_t m_index;
				    	
				    	::opendlv::proxy::reverefh16::Steering m_opendlv_proxy_reverefh16_Steering;
				    	
				}; // end of class "Steering"
...
#endif /*OPENDLV_PROXY_REVEREFH16_STEERING_H_*/
