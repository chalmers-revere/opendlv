...
#ifndef OPENDLV_LEGACY_VANISHINGPOINT_LANE_MARKINGS_SCAN_H_
#define OPENDLV_LEGACY_VANISHINGPOINT_LANE_MARKINGS_SCAN_H_
...
#endif /* OPENDLV_LEGACY_VANISHINGPOINT_LANE_MARKINGS_SCAN_H_ */
