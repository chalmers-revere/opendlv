...
#ifndef COMMUNICATOR_LEDSTRIP_LEDSTRIP_HPP_
#define COMMUNICATOR_LEDSTRIP_LEDSTRIP_HPP_
 ...
 * This class provides...
 */
class Ledstrip : public core::base::module::DataTriggeredConferenceClientModule {
  public:
